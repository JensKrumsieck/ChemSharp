...
public class ConnectedFiguresBenchmarks
{
	...
	public ConnectedFiguresBenchmarks()
	{
		...
		var edges = new[]
		{
			new Edge<int>(1, 3), new Edge<int>(2, 4), new Edge<int>(3, 5), new Edge<int>(3, 6), new Edge<int>(4, 7),
			new Edge<int>(5, 8), new Edge<int>(5, 6), new Edge<int>(8, 9), new Edge<int>(9, 10),
		};
